...
curl --location "https://gitlab.com/mauchede/phpstorm-config/raw/mac-os/darwin/bin/installer" | sh -s -- install

# Configure webstorm

curl --location "https://gitlab.com/mauchede/webstorm-config/raw/mac-os/darwin/bin/installer" | sh -s -- install
